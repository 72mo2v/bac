...
Revision ID: b7792ed95ff3
Revises: 
Create Date: 2026-01-25 15:04:18.318642
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('SUPER_ADMIN', 'STORE_OWNER', 'STORE_ADMIN', 'COURIER', 'CUSTOMER', name='userrole'), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('store_id', sa.Integer(), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'ACTIVE', 'INACTIVE', 'SUSPENDED', name='courierstatus'), nullable=True),
    ...
    sa.Column('status', sa.Enum('PENDING', 'ACCEPTED', 'PREPARING', 'READY', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'RETURNED', name='orderstatus'), nullable=True),
    sa.Column('total_amount', sa.Float(), nullable=False),
    sa.Column('shipping_address', sa.String(), nullable=False),
    sa.Column('delivery_qr_code', sa.String(), nullable=True),
    ...
    sa.Column('status_from', sa.Enum('PENDING', 'ACCEPTED', 'PREPARING', 'READY', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'RETURNED', name='orderstatus'), nullable=True),
    sa.Column('status_to', sa.Enum('PENDING', 'ACCEPTED', 'PREPARING', 'READY', 'OUT_FOR_DELIVERY', 'DELIVERED', 'CANCELLED', 'RETURNED', name='orderstatus'), nullable=True),
    ...
    sa.Column('method', sa.Enum('CASH_ON_DELIVERY', 'BANK_TRANSFER', 'ONLINE_PAYMENT', 'WALLET', name='paymentmethod'), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'COMPLETED', 'FAILED', 'REFUNDED', 'REJECTED', name='paymentstatus'), nullable=True),
